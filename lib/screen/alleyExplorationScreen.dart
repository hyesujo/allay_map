...
class AlleyExplortionScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppbar(
          ...
          press2: () => Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => AlleyMapScreen())),
        ),
      ),
      drawer: ReviewDrawer(w: size),
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text(
              '가보고 싶은 장소',
              style: GoogleFonts.nanumGothic(fontSize: 18),
            ),
          ),
          Container(
          ...
          Expanded(
            child: InkWell(
              onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => AlleyMapScreen())),
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: AssetImage(
                      'assets/images/exeploer.png'), // 장소를 추가하면 그림이 없어지게
                )),
              ),
            ),
          ),
